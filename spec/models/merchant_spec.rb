...
RSpec.describe Merchant, type: :model do
  ...
  it 'returns top 5 items' do
    ...
    transactions_1= create_list :transaction, 10, result: 0, invoice: invoice.first
    transactions_2= create_list :transaction, 10, result: 0, invoice: invoice.second
    transactions_6= create_list :transaction, 10, result: 0, invoice: invoice.third
    transactions_3= create_list :transaction, 10, result: 0, invoice: invoice.fourth
    transactions_4= create_list :transaction, 10, result: 0, invoice: invoice.fifth
    transactions_5= create_list :transaction, 10, result: 0, invoice: invoice[5]
    invoice_item_2 = create :invoice_item, unit_price: 500, quantity: 1, item: item_2, invoice: invoice.first
    invoice_item_3 = create :invoice_item, unit_price: 400, quantity: 1, item: item_3, invoice: invoice.second
    invoice_item_1 = create :invoice_item, unit_price: 300, quantity: 1, item: item_1, invoice: invoice.third
    invoice_item_4 = create :invoice_item, unit_price: 600, quantity: 1, item: item_4, invoice: invoice.fourth
    invoice_item_5 = create :invoice_item, unit_price: 200, quantity: 1, item: item_5, invoice: invoice.fifth
    invoice_item_6 = create :invoice_item, unit_price: 100, quantity: 1, item: item_6, invoice: invoice[5]

    expect(merchant.top_5_items).to eq([item_4, item_2, item_3, item_1, item_5])
  end
